...
router
  .route("/latest/:topic")
  .get(VerifyWithoutThrowingError, getLatestStories);
router
  .route("/popular/:topic")
  .get(VerifyWithoutThrowingError, getPopularStories);
router
  .route("/gettopicdetail/:topic")
  .get(VerifyWithoutThrowingError, getTopicDetail);
