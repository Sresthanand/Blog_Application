...
router
  .route("/getfollowingstory")
  .get(VerifyWithoutThrowingError, getFollowingStories);
router
  .route("/getsuggestedstory")
  .get(VerifyWithoutThrowingError, getSuggestedStory);
router
  .route("/getsuggesteduser")
  .get(VerifyWithoutThrowingError, getSuggestedUser);
router
  .route("/getsuggestedtopic")
  .get(VerifyWithoutThrowingError, getsuggestedTopic);
