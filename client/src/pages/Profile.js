...
const Profile = () => {
  ...
  const { isFetchingfollower, Followers, curr2Index } = useSelector(
    (state) => state.followers
  );
  const { isFetchingfollowing, Followingpeople, currIndex } = useSelector(
    (state) => state.followingpeople
  );
  const { isFetchingMyStories, currindex, Mystories } = useSelector(
    (state) => state.Mystories
  );
  const { isFetchingSaved, SavedStories, curr5Index } = useSelector(
    (state) => state.SavedStory
  );
  const { isFetchingLiked, Likedstories, curr4Index } = useSelector(
    (state) => state.likedstory
  );
  const { isFetchingreadingList, readingList, curr3Index } = useSelector(
  ...
  const fetchData = ({ type }) => {
    switch (type) {
      ...
      case "following":
        isFetchingfollowing &&
          dispatch(Fetchfollowingpeople({ currIndex, user }));
        break;
      case "mystory":
      ...
      case "readinglist":
        isFetchingreadingList &&
          dispatch(FetchreadingList({ curr3Index, user }));
        break;
      default:
        break;
    }
  ...
  return (
    <div className="profile_page">
      {Profile && Profile.cover ? (
        ...
        >
          <div
            style={{ width: "100%", height: "100%", background: "#ffffff66" }}
          >
        ...
        <div
          className="profile_header"
          style={{ backgroundImage: `url(${deffault})` }}
        >
          <div
            style={{ width: "100%", height: "100%", background: "#ffffff66" }}
          >
      ...
      <div className="profile_tab">
        {!Profile?.isMe ? (
          <div
            ...
            onClick={() =>
              Useraction({
                type: "togglefollowpeople",
                payload: { uid: Profile?._id },
              })
            }
          >
            {Profile?.isFollowing ? (
        ...
        <div className="p_tabs">
          <div
            className={tabstate === 2 ? "selected-tab" : ""}
            onClick={() => {
              fetchData({ type: "profile" });
              setTabState(2);
            }}
          >
            About
          ...
          <div
            className={tabstate === 0 ? "selected-tab" : ""}
            onClick={() => {
              fetchData({ type: "mystory" });
              setTabState(0);
            }}
          >
            Stories
          ...
          <div
            className={tabstate === 1 ? "selected-tab" : ""}
            onClick={() => {
              fetchData({ type: "followers" });
              setTabState(1);
            }}
          >
            Followers
          ...
          <div
            className={tabstate === 3 ? "selected-tab" : ""}
            onClick={() => {
              fetchData({ type: "following" });
              setTabState(3);
            }}
          >
            Following
          ...
          {Profile?.isMe && (
            <>
              <div
                className={tabstate === 4 ? "selected-tab" : ""}
                onClick={() => {
                  fetchData({ type: "readinglist" });
                  setTabState(4);
                }}
              >
                Read
              ...
              <div
                className={tabstate === 5 ? "selected-tab" : ""}
                onClick={() => {
                  fetchData({ type: "likedstory" });
                  setTabState(5);
                }}
              >
                Liked
              ...
              <div
                className={tabstate === 6 ? "selected-tab" : ""}
                onClick={() => {
                  fetchData({ type: "savedstory" });
                  setTabState(6);
                }}
              >
                Saved
