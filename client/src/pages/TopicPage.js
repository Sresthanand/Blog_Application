...
import {
  FetchTopicdetail,
  togglefollowTopicIn,
} from "../reducers/getTopicDetail";
import {
  Fetchpopularstories,
  SaveUnsavePopularStory,
} from "../reducers/getPopularStories";
import {
  FetchlatestStory,
  SaveUnsaveLatestStory,
} from "../reducers/getLatestStories";
    ...
    <div className="topicpage">
      <div className="left_side">
        <div
          ...
          style={{ backgroundImage: `url(${topicDetail.cover})` }}
        >
          <div className="topic_intro_mobile">
            <div className="topic_name">
              <div style={{ fontSize: "22px" }}>{topicDetail.name}</div>
              <div
                onClick={() =>
                  Useraction({
                    type: "togglefollowtopic",
                    payload: topicDetail.name,
                  })
                }
            ...
            <div className="topic_des">{topicDetail.description}</div>
          </div>
        </div>
      ...
      <div className="right_side">
        ...
        <div className="related_topic">
          ...
          {topicDetail?.relatedTopics?.map((topic) => (
            <div
              className="rel_topic"
