...
export const togglefollowPeople = createAsyncThunk(
  ...
  async ({ payload, callback }) => {
    const status = await FetchData("/user/togglefollowpeople", {
      body: payload,
    });
...
export const togglefollowTopic = createAsyncThunk(
  ...
  async ({ payload, callback }) => {
    // console.log(payload);
    const status = await FetchData("/user/togglefollowtopic", {
      body: { name: payload },
    });
...
export const deleteUser = createAsyncThunk(
  "user/deleteAccount",
  async ({ payload, callback }) => {
    const data = await FetchData("/admin/deleteUserId/" + payload, {
      method: "DELETE",
    });
    console.log(data);
    if (data.success) {
...
export const deleteStory = createAsyncThunk(
  "user/deletestory",
  async ({ payload, callback }) => {
    const data = await FetchData("/admin/deleteStory/" + payload, {
      method: "DELETE",
    });
