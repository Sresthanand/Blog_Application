...
export const FetchSearchedstory = createAsyncThunk(
  "story/search",
  async ({ curr2Index, term }) => {
    const data = await FetchData(`/story/search?currIndex=${curr2Index}`, {
      body: { term },
    });
    return data;
  }
...
export const { SaveUnsaveSearchStory, ClearSearchStory } =
