...
export const FetchFollowingStory = createAsyncThunk(
  "user/followingstories",
  async ({ currIndex }) => {
    const data = await FetchData(
      `/user/getfollowingstory?currIndex=${currIndex}`
    );
    return data;
  }
);
...
export const { SaveUnsaveStory } = FollowingStorySlice.actions;
